let bars = [];
const def = "hsla(100, 5.40%, 43.50%, 0.72)", chng = "#27b4f5", finished = "rgb(137, 117, 93)", selected = "Yellow";
...
function Finished_Sorting() {
	...
	let timeComplexity = getTimeComplexity(sortingAlgorithm);

	let sortingInfo = document.getElementById("sortingInfo");
	sortingInfo.innerHTML = `<p>Sorting Algorithm: ${sortingAlgorithm}</p>
...
// Function to get the time complexity based on the selected sorting algorithm
function getTimeComplexity(algorithm) {
	switch (algorithm) {
		case "SelectionSort":
			return "Worst - O(n^2),  Avg - O(n^2)";
		case "BubbleSort":
			return "Worst - O(n^2),  Avg - O(n^2)";
		case "InsertionSort":
			return "Worst - O(n^2),  Avg - O(n^2)";
		case "MergeSort":
			return "Worst - O(n(log n)),  Avg - O(n(log n))";
		case "QuickSort":
			return "Worst - O(n^2),  Avg - O(n(log n))";
		case "HeapSort":
			return "Worst - O(n(log n)),  Avg - O(n(log n))";
		default:
			return "Unknown";
...
function generateBars(n = -1) {
	...
	for (let i = 0; i < n; i++) {
		...
		bars.push(
			'<div class="boxi">' +
			'<div class="bar" id="' + i + '" style="height:' + height + '%"></div>' +
			'<div class="bar-height">' + height + '</div>' +
			'</div>'
		);
	}
...
function runSelectedSort() {
	let selectedAlgorithm = document.getElementById("sortingAlgorithm").value;
...
// let bars = [];
// const def = "#b89874", chng = "#27b4f5", finished = "hsla(100, 5.40%, 43.50%, 0.72)", selected = "Yellow";
